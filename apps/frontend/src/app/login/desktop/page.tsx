      ...
      <main className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 bg-surface-container-lowest rounded-xl overflow-hidden editorial-shadow">
        ...
        <section className="p-8 md:p-16 flex flex-col justify-center">
          ...
          <form action="#" className="space-y-6">
            ...
            <Link href="/dashboard" className="w-full py-6 bg-gradient-to-r from-primary to-primary-container text-on-primary font-semibold rounded-lg shadow-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2 group border-none">
              Sign In
