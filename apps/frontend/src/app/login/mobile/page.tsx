    ...
    <div className="bg-background text-on-surface font-body min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <main className="w-full max-w-sm flex flex-col">
        ...
        <section className="space-y-6">
          ...
          {/* Action Button */}
          <Link href="/dashboard" className="flex items-center justify-center w-full h-14 bg-gradient-to-r from-primary to-primary-container text-white font-headline font-bold rounded-xl editorial-shadow active:scale-95 transition-transform border-none hover:opacity-90">
            Sign In
          </Link>
