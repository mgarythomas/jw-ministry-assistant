...
export default function ElderDashboard() {
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen pb-32">
      <TopAppBar activeTab="Congregation" />
      ...
      <main className="pt-24 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            <Link href="/territory-management" className="flex-1 flex flex-col">
            ...
            <Link href="/publisher-portal" className="flex-1 flex flex-col">
              <Card className="flex-1 bg-surface-container-low p-6 rounded-2xl group hover:bg-primary-container transition-all border-none shadow-none cursor-pointer">
                <CardContent className="p-0 flex items-center justify-between">
                  <div className="flex flex-col">
                    <span className="text-on-surface font-bold text-lg group-hover:text-on-primary">
          ...
          <Card className="md:col-span-12 lg:col-span-5 bg-surface-container-lowest p-8 rounded-2xl border-none shadow-none">
            ...
            <Link href="/meeting-scheduler" className="w-full mt-8 py-6 bg-primary text-on-primary font-bold rounded-xl shadow-lg shadow-primary/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform text-md">
              View Full Schedule
            </Link>
          </Card>
